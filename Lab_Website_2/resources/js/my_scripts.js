...
function changeColor(color) {
	document.getElementById("homeBody").style.backgroundColor = color;
}
/*
...
function loadStatsPage(){
	...
	{
		cell_value = parseInt(table.rows[row_counter].cells[2].innerHTML);
...
function loadPlayersPage(){
	var buttons = "<button onclick='switchPlayers(0)'> " + players[0].name + "</button>";
	for(var i = 1; i < players.length; i++){
		buttons +=  "<button onclick='switchPlayers(\""+ i +"\")'> " + players[i].name + "</button>";
	}
